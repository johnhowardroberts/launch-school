...
hsh2[:third].key(0) # use #key method to referenc the index position object
...
# Although this looks very similar to the initial solution,
# Hash#key and Hash#keys are actually two completely different methods.
